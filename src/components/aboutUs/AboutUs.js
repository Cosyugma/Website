    ...
    return (
            ...
            <div className='about-container'>
                ...
                <div className='aboutus'>
                    ...
                    <div className='aboutus-details'>
                        The world of Shree Cement is one without boundaries –
                        changing and challenging every day. We make cement and
                        through it we touch lives of millions of people every day.
                        From the house you live in, the roads you to drive on, to
                        the bridges you cross, we strive to deliver unparalleled
                        quality through our customised products and value added
                        solutions.
                ...
                <div className='topper-container'>
                    <div className='topper-item'>
                        <img src='	https://www.shreecement.com/uploads/cleanupload/business-build-icon.png' />
                        <p className='sub-para'>Among the top</p>
                        <h1>
                            <span>3</span>
                        </h1>
                        <p>Cement groups in India</p>
      ...
      <div className='about-information-container'>
                ...
                <div className='welcome-box'>
                        ...
                        <h3>Welcome to the world of Shree Cement where we create new records and better them consistently as a routine.</h3>
